...
export const TRANSLATIONS = {
    en: {
        ...
        'editor.code': 'Code',
        'editor.link': 'Link',
        'editor.spellcheck': 'Fix Spelling & Grammar',
        'editor.summarize': 'Summarize Text',
        ...
        'theme.lite_mode': 'Lite Mode',
        'theme.app_scale': 'Interface Scale',
        'theme.ai_enable': 'Enable AI Features',
        'theme.ai_provider': 'AI Provider',
        'theme.ai_model': 'AI Model',
        'theme.ai_key': 'OpenAI API Key (Local only)',
        'theme.ai_key_placeholder': 'sk-...',
        ...
        'help.front_matter': 'Hugo Front-Matter Magic',
        ...
        'theme.anim_custom': 'Custom Colors',
        'theme.custom_colors': 'Wallpaper Colors',
    ...
    pt: {
        ...
        'editor.code': 'Código',
        'editor.link': 'Link',
        'editor.spellcheck': 'Corrigir Gramática e Ortografia',
        'editor.summarize': 'Resumir Texto',
        'theme.title': 'Configurações',
        ...
        'theme.lite_mode': 'Modo Lite',
        'theme.app_scale': 'Escala da Interface',
        'theme.ai_enable': 'Habilitar Recursos de IA',
        'theme.ai_provider': 'Provedor de IA',
        'theme.ai_model': 'Modelo de IA',
        'theme.ai_key': 'Chave de API OpenAI (Salva Localmente)',
        'theme.ai_key_placeholder': 'sk-...',
        ...
        'help.front_matter': 'Gerar Front-Matter (Hugo)',
        ...
        'theme.anim_sunset': 'Pôr do Sol',
        'theme.anim_custom': 'Cores Customizadas',
        'theme.custom_colors': 'Cores do Papel de Parede',
        'about.title': 'Sobre o Emerald',
        'about.version': 'Versão 1.0.6',
    ...
    es: {
        ...
        'editor.code': 'Código',
        'editor.link': 'Enlace',
        'editor.spellcheck': 'Corregir Ortografía',
        'editor.summarize': 'Resumir Texto',
        'theme.title': 'Configuración',
        'settings.general': 'General',
        'settings.editor': 'Editor',
        ...
        'theme.lite_mode': 'Modo Lite',
        'theme.app_scale': 'Escala de Interfaz',
        'theme.ai_enable': 'Habilitar Funciones de IA',
        'theme.ai_provider': 'Proveedor de IA',
        'theme.ai_model': 'Modelo de IA',
        'theme.ai_key': 'Clave API OpenAI (Local)',
        'theme.ai_key_placeholder': 'sk-...',
        ...
        'help.front_matter': 'Generar Front-Matter (Hugo)',
        ...
        'theme.anim_custom': 'Colores Personalizados',
        'theme.custom_colors': 'Colores de Fondo',
        'about.title': 'Acerca de Emerald',
        'about.version': 'Versión 1.0.6',
